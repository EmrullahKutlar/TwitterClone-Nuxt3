<template>
    <div class=" h-screen flex flex-col ">
        ...
        <div class="flex flex-row items-center justify-center px-2 py-2 mx-auto mt-auto mb-5 rounded-full cursor-pointer w-14, xl:w-full
        hover:bg-gray-100 dark:hover:bg-dim-800" :class="defaultTransition"
...
import {
    HashtagIcon, BellIcon, InboxIcon, BookmarkIcon,
    DocumentTextIcon, UserIcon, DotsCircleHorizontalIcon, PencilIcon, ChevronDownIcon
